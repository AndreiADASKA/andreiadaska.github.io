...
const isValid = (value, lowerBound, upperBound) => isBetween(value, lowerBound + 1, upperBound);
...
const validateTriangle = (sides, lowerBound, upperBound) => {
   const validationResults = sides.map((side) => validateSide(side, lowerBound, upperBound));
